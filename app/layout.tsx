...
export const metadata: Metadata = {
    ...
    description:
        "The official platform for settling public debates through voting. Create polls, vote on options, and see live rankings.",
    keywords: [
        "debate",
        "voting",
        "polls",
    ...
    openGraph: {
        ...
        description:
            "Create polls, vote on options, and see live rankings on the most democratic debate platform.",
        images: [
            {
                url: "/og-image.png",
                width: 1200,
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            name: "Letsettle",
                            description:
                                "The official platform for settling public debates through voting.",
                            url:
                                process.env.NEXT_PUBLIC_APP_URL ||
                                "https://letsettle.rafey.space",
                            potentialAction: {
                                "@type": "SearchAction",
                                target: `${
                                    process.env.NEXT_PUBLIC_APP_URL ||
